...
export const constantRoutes = [
  ...
  },
  {
    ...
    children: [
      {
        path: 'bill/:comId(\\d+)',
        component: resolve => require(['@/views/account/billAccount'], resolve),
        name: 'Data',
        meta: { title: '历史账单', icon: '' },
      },
    ],
  },
  {
  ...
  },
  {
    ...
    children: [
      {
        path: 'documentation',
        component: resolve => require(['@/views/record/documentation'], resolve),
        name: 'Documentation',
        meta: { title: '开发文档' },
      },
    ],
  },
  {
    ...
    children: [
      {
        path: 'TS',
        component: resolve => require(['@/views/ts/index'], resolve),
        name: 'TS',
        meta: { title: 'TS' },
      },
    ],
