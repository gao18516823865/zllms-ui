<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" border :data="list" @selection-change="handleQuery">
        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="模型logo" prop="modelLogo">
              <el-input v-model="form.modelLogo" placeholder="模型logo" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
...
<script>
import { modelInfoListUrl, getModelInfo, addModelInfo, updateModelInfo, modelInfoStatus } from '@/api/model/model';
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      modelInfoListUrl(this.addDateRange(this.queryParams, this.dateRange)).then(response => {
